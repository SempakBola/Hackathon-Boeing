...
public class PageST31 implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<head>" + 
               "<title>Local Government Area Information 2.0 - Hope For Homes</title>";
...
//------------------------------------------------------------------------------------------------
        ...
        html = html + """
            <div class='header2'>
                <h2>Local Government Area Information 2.0</h2>
            </div>

            <div class='breadcrumbs'>
                <i><a href='/' title='Home'>Homepage</a> / <a href='page5.html' title='LGA Information'>Local Government Area Information 2.0</a></i>
            </div>
        """;
...
//------------------------------------------------------------------------------------------------
       ...
       // html = html + "</form>";
        ...
        //Income
        html = html + "   <div class='form-group'>";
        html = html + "      <label for='income_drop'>Income Information: (Must select all above parameters to view income info)</label>";
        html = html + "      <select id='income_drop' name='income_drop'>";
        ...
        */
        ...
        else if ( (income_drop != null) ){
            html = html + outputMoviesAndIncome(lga_textbox, movietype_drop, gender_drop, status_drop, income_drop);
        }
...
//------------------------------------------------------------------------------------------------
    ...
    public String outputMoviesAndIncome(String lga_name, String ageGroup, String sex, String status, String income) {
    
        // Look up lga from JDBC
        JDBCConnection jdbc = new JDBCConnection();
        ArrayList<LGA> lga = jdbc.getLgaIncome(lga_name, ageGroup, sex, status, income);
