 ...
 */
public class HomelessPopulationIncomeProcessCSV {
   ...
   private static final String CSV_FILE = "database/homeless-2018-AtRisk.csv";
      ...
      try {
         ...
         while (lineScanner.hasNext()) {
            ...
            while (rowScanner.hasNext() && indexAgeCategory < ageCategory.length) {
               ...
               String count2 = rowScanner.next();
               String count3 = rowScanner.next();
               String count4 = rowScanner.next();
               String count5 = rowScanner.next();
               String count6 = rowScanner.next();
               String count7 = rowScanner.next();
               String count8 = rowScanner.next();
               String count9 = rowScanner.next();
               String count10 = rowScanner.next();
               String count11 = rowScanner.next();
               String count12 = rowScanner.next();
               String count13 = rowScanner.next();
               String count14 = rowScanner.next();
               ...
               String query = "INSERT into AtRisk18 VALUES ("
                              + lgaCode + ","
                              //+ "'" + year + "',"
                              + count + ","
                              + count2 + ","
